...
const BookFilters = ({ onApplyFilters }) => {
  ...
  const handleApplyFilters = () => {
    const filters = {
      priceRange,
      language: selectedLanguage === "All" ? null : selectedLanguage, // Handle "All" as no filter
      genre: selectedGenre === "All" ? null : selectedGenre, // Handle "All" as no filter
    };
  ...
  const handleResetFilters = () => {
    setPriceRange([0, 100]);
    setSelectedLanguage("All"); // Reset to "All" for language
    setSelectedGenre("All"); // Reset to "All" for genre
    onApplyFilters({});
    setOpenMobileFilters(false);
  };
