...
class CustomTokenObtainPairView(TokenObtainPairView):
    ...
    """
    permission_classes = [AllowAny]  # Allow unauthenticated access (users don't have tokens yet)
...
class CustomTokenRefreshView(TokenRefreshView):
    ...
    """
    permission_classes = [AllowAny]  # Allow unauthenticated access (only refresh token needed)
...
class TokenBlacklistView(APIView):
    ...
    This invalidates the token for future use.
